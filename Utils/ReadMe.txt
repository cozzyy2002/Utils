...
この Utils ライブラリ プロジェクトは、AppWizard により作成されました。

このファイルには、Utils アプリケーションを構成する各ファイルの内容の概要が含まれています。
...
StdAfx.h, StdAfx.cpp
    これらのファイルは、Utils.pch という名前のプリコンパイル済みヘッダー (PCH) ファイルと、StdAfx.obj という名前のプリコンパイル済みの型ファイルをビルドするために使用されます。
...
参考:
O'REILLY Effective Modern C++
Scott Meyers 著、千住治郎 訳
都立中央図書館 007.6 8762 2015
